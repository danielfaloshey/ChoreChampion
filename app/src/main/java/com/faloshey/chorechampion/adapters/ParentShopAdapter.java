...
public class ParentShopAdapter extends RecyclerView.Adapter<ParentShopAdapter.ShopViewHolder> {
    ...
    public ParentShopAdapter(List<ShopItemModel> itemList, OnItemClickListener clickListener) {
